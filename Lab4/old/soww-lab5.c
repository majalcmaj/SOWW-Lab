...
int main(int argc, char **argv) { 
  ...
  ///////TUTAJ PRAGMA
#pragma omp parallel sections num_threads(2)  default(none) shared(myrank,a,b,proccount) private(requests,ranges,resulttemp,sentcount,i,range,result,recvcount,requestcompleted,status)
{ 
...
ranges[2*i+2*proccount+1]=range[1];
