...
rm cgs.cu.o
rm cgs_lab 
/usr/local/cuda/bin/nvcc -ccbin g++ -I/usr/local/cuda/samples/common/inc  -m64     -o cgs.cu.o -c cgs.cu
/usr/local/cuda/bin/nvcc -ccbin g++ -m64 -o cgs_lab cgs.cu.o  -lcublas -lcusparse
